...
.table-container{
  ...
  min-height:100px;
  max-height: 60vh; 
  overflow-y: scroll; /* vertical scrollbar to table */
}
.main-container {
    display: block;
    padding: 10px 0px;
...
<body>
  ...
  <h1 >Manage Users</h1>
            ...
            <button onclick="document.location='manageUser.php'">All User List</button>
        ...
        <?php
            ...
            if (isset($_GET['search'])) {
              ...
              $query = "SELECT * FROM user_details WHERE username LIKE '%$search%'";
            } else {
      ...
      <?php
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td class="delete-cell"><a href="delete-user.php?id=' . $row['id'] . '">Remove User</a></td>';
            echo '</tr>';
          }
      ?>
          </tbody>
